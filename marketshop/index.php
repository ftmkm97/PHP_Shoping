            ...
            <li class="dropdown information-link"><a>برگه ها</a>
              <div class="dropdown-menu">
                <ul>
				 ...
				 <ul>
                  <li><a href="question.php">سوالات متداول</a></li>
      ...
      <div class="row">
        ...
        <div id="content" class="col-xs-12">
          ...
          <div class="slideshow single-slider owl-carousel">
            <div class="item"> <a href="#"><img class="img-responsive" src="image/slider/2.jpg" alt="banner 2" /></a> </div>
            <div class="item"> <a href="#"><img class="img-responsive" src="image/slider/1.jpg" alt="banner 1" /></a> </div>
          </div>
          <!-- Slideshow End-->
    ...
    <div class="container">
      ...
      <div class="owl-carousel product_carousel_tab">
            ...
            <div class="product-thumb clearfix">
              <div class="image" style="width:200px;hight:200px">
			  <img src="image/product/<?php echo $product['productID']?>.jpg"   alt=<?php echo $product['name']?> title=<?php echo $product['name']?> class="img-responsive" /></div>
              <div class="caption">
