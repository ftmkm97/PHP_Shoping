  ...
  <div id="container">
    ...
    <div class="container">
        ...
        <div id="content" class="col-xs-12">
           ...
           <form class="form-horizontal"   action="show.php?username=<?php echo $_GET['username']?>" method="post"  >
            <fieldset id="account">
              <legend>جستجو محصولات</legend>
			  
			 
              <div class="form-group required">
                <label for="input_name" class="col-sm-2 control-label">شاخص جستجو</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="input_name" placeholder="نام محصول را وارد کنید" value="" name="name">
                </div>
              </div>
