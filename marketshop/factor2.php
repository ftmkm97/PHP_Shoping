...
$row2=getDiscountPercentbyID($_GET['discountID']);
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown information-link"><a>برگه ها</a>
              <div class="dropdown-menu">
                ...
                <!--  <li><a href="productcustomer.php">محصولات</a></li>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div id="content" class="col-sm-12">
              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
					...
					<td class="text-right">درصدتخفیف </td>
                  ...
                  <tr>
					...
					<?php echo $DiscountPercent ?>
						...
						<div class="input-group btn-block quantity">
							<?php echo ($Sum['sum(totalPrice)'] *( (100-$DiscountPercent)/100)) + 10000;?>
          ...
          <div class="buttons">
            <div class="pull-left"><a href="insertIntoFactor.php?username=<?php echo $_GET['username']?>&discountID=<?php echo $_GET['discountID']?>" class="btn btn-default">تکمیل خرید</a></div>
