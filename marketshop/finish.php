    ...
    <!-- Main  Start-->
      ...
      <nav id="menu" class="navbar">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          ...
          <!--  <li><a class="home_link" title="خانه" href="dashboard.php">خانه</a></li>-->
              ...
              <div class="dropdown-menu">
               ...
               <li><a href="productcustomer.php">محصولات</a></li>
                ...
                <ul>
                  ...
                  <li><a href="questiondashboard.php">سوالات متداول</a></li>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div id="content" class="col-sm-12">
			...
			<p style="font_famili:homa;color:#B8860B;size:60px">خرید شما یا موفقیت به پایان رسید....!!!</p>
