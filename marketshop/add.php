...
$PID=$_POST['productID'];
var_dump($_POST);
 addNewProduct($_POST['productID'],$_POST['name'],$_POST['number'],$_POST['price'],$_POST['factory'],$_POST['product'],$_POST['expirat'],$_POST['weight'],$_POST['discount']);
  $date= date("Y/m/d");
// var_dump($date);
 addToManagement($PID,$username,$status,$date);

if(isset($_FILES['img']) && $_FILES['img']['size']){
		move_uploaded_file($_FILES['img']['tmp_name'],"image/product/$_POST[productID].jpg");
		}
...
<div class="wrapper-wide">
  ...
  <div id="container">
    ...
    <div class="container">
        ...
        <li><a href="">اضافه کردن محصول </a></li>
      </ul>
           ...
           <form class="form-horizontal"   action="" method="post" enctype="multipart/form-data" >
            <fieldset id="account">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="input-name" placeholder="نام محصول" value="" name="name">
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="input-product" placeholder="2019-01-01" value="" name="product">
                </div>
              </div>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="input-expirat" placeholder="2019-01-01" value="" name="expirat">
                </div>
              </div>
              
              <div class="form-group required">
                <label for="input-weight" class="col-sm-2 control-label">وزن محصول</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="input-weight" placeholder="وزن محصول" value="" name="weight">
                </div>
              </div>
              <div class="form-group required">
			  ...
			  <div class="form-group">
					<label class="control-label" style= "font-family:homa ; color:#B8860B" for="input-title">عکس خبر</label>
